...
mod tests {
    ...
    use crate::integer;
    use crate::maingate;
    use ecc::halo2::dev::MockProver;
    use ecc::halo2::halo2curves::group;
    use ecc::halo2::halo2curves::group::prime::PrimeCurveAffine;
                ...
                .assign_region(
                    ...
                    |mut region| {
                        ...
                        for i in 0..self.batch_size {
                            ...
                            let msg_hash = ecc_chip.new_unassigned_scalar(Value::known(bevi.m_hash[i]));
                            let challenge_p =
                                ecc_chip.new_unassigned_scalar(Value::known(bevi.challenge[i]));
                            let sig_point_assigned =
                                ecc_chip.assign_point(ctx, Value::known(bevi.sig_point[i].into()))?;
